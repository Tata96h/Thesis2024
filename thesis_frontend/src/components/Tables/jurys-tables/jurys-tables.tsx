...
// export function ChoixTable<TData, TValue>({
//   columns,
//   data,
//   searchKey,
//   pageNo,
...
//     pageIndex: pageNo - 1,
//     pageSize: Number(searchParams.get("limit")) || pageSizeOptions[0],
//   });
...
//     if (globalFilter) {
//       newSearchParams.set("search", globalFilter);
//     } else {
...
//           </div>
//         </div>
//         <div className="flex w-full items-center justify-end lg:w-auto space-x-2">
//           <Button
//             variant="outline"
//             size="icon"
...
export function JuryTable<TData, TValue>({
  columns,
  data,
  pageNo,
  searchKey,
  ...
  }, [pageIndex, pageSize, globalFilter, pathname, router, createQueryString]);
